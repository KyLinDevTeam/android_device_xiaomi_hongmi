...
. build/envsetup.sh && lunch cm_hongmi-eng
...
make_mtk_image () {
# copy MTK tools
rm out/target/product/hongmi/CWM_recovery_Hongmi.img
rm -rf out/target/product/hongmi/mtk-tools
cp -r device/xiaomi/hongmi/mtk-tools out/target/product/hongmi/mtk-tools

# MTK tools permissions
chmod 777 out/target/product/hongmi/mtk-tools/mkbootimg out/target/product/hongmi/mtk-tools/repack-MT65xx.pl out/target/product/hongmi/mtk-tools/unpack-MT65xx.pl

# Prepare ramdisk
cd out/target/product/hongmi/mtk-tools
...
echo -e "${TXT_BLUE}Recovery image created: out/target/product/hongmi/CWM_recovery_Hongmi.img${TXT_RST}"
}
